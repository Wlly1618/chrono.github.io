...
var add_f = document.getElementById('add1');
var sub_f = document.getElementById('sub1');
var add_s = document.getElementById('add2');
var sub_s = document.getElementById('sub2');
...
function reboot_chrono()
{
    clearInterval(interval);
    interval = null;
    min = 0; sec = 0; ms = 0; j = 0; k = 0;
    lights[0].textContent = '';
    lights[2].textContent = '';
    print_time();
}
